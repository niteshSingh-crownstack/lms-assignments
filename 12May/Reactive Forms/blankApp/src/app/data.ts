export let _statesData = [
  ...
  { state: 'Dadra and Nagar Haveli (DN)', cities: ['Dadra and Nagar Haveli'] },
  { state: 'Daman and Diu (DD)', cities: ['Daman', 'Diu'] },
  {
    state: 'Delhi (DL)',
    cities: [
      'Central Delhi',
  ...
  { state: 'Goa (GA)', cities: ['North Goa', 'South Goa'] },
  {
    state: 'Gujarat (GJ)',
    cities: [
      'Ahmedabad',
